...
import pyswitch
from pyswitch.base.switch_object import SwitchObject
...
class Event(SwitchObject):
    def __init__(
        self,
        type: Optional["pyswitch.EventType"] = None,
        data: Optional[dict] = None,
        community_id: Optional[str] = None,
        community: Optional["pyswitch.Community"] = None,
        group_id: Optional[str] = None,
        group: Optional["pyswitch.Group"] = None,
        channel_id: Optional[str] = None,
        channel: Optional["pyswitch.Channel"] = None,
        action_by_id: Optional[str] = None,
        action_by: Optional["pyswitch.User"] = None,
    ):
        self.type = type
        self.data = data
    ...
    def from_json(self, data: pyswitch.JSONDict) -> "Event":
        if data is not None:
            details = data.get("details") or {}
            self.type = pyswitch.EventType(data.get("type"))
            self.action_by_id = details.get("actionById")
            self.action_by = pyswitch.User.build_from_json(details.get("actionBy"))
            self.community_id = details.get("communityId")
            self.community = pyswitch.Community.build_from_json(details.get("community"))
            self.group_id = details.get("groupId")
            self.group = pyswitch.Group.build_from_json(details.get("group"))
            self.channel_id = details.get("channelId")
            self.channel = pyswitch.Channel.build_from_json(details.get("channel"))
            self.data = details
        return self

    def to_json(self) -> pyswitch.JSONDict:
        return {
            "type": self.type,
            "details": self.data,
