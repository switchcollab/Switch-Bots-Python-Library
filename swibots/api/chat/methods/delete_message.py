...
class DeleteMessage:
    async def delete_message(self: "swibots.ApiClient", message: int | Message) -> bool:
        ...
        """
        logging.warning("This method is deprecated and is going to be removed in the future! Use client.delete_messages to achieve same results!")
        return await self.chat_service.messages.delete_messages([message])

    async def delete_messages(self: "swibots.ApiClient", message_ids: List[Union[int, Message]]) -> bool:
